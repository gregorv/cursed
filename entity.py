...
class SkillSet:
    skill_def = {
        ...
        "char.hp_regen": (0, 250, None, "HP Regen", "HP Regeneration rate", lambda s: True),
        "char.mana_regen": (0, 250, None, "Mana Regen", "Mana Regeneration rate", lambda s: True),
        ...
        "char.magic": (1, 500, None, "Magic", "Magical strength", lambda s: True),
        "char.spirit": (1, 1000, None, "Spirit", "Defence against magical attacks", lambda s: True),
        "weapon.sword": (0, 500, None, "Swords and Daggers", "Sword attack damage", lambda s: True),
        "weapon.mace": (0, 500, None, "Mace and Clubs", "Mace and Club fighting skill", lambda s: True),
        "weapon.staff": (0, 500, None, "Staffs", "Staff fighting skill", lambda s: True),
        "weapon.bow": (0, 500, None, "Bows and Arrows", "Bow fighting skill", lambda s: True),
        "magic.elemental": (0, 500, None, "Elemental Magic", "Elemental magical strength", lambda s: True),
        "magic.neutral": (0, 500, None, "Neutral Magic", "Strength of non-elemental magic", lambda s: True),
        "magic.healing": (0, 500, None, "Healing Magic", "Non-elemental magic strength", lambda s: True),
        "magic.status": (0, 500, None, "Status Magic", "State changing magic", lambda s: True),
        "elemdef.fire": (0, 750, 40, "Fire", "Defence against elementary damage", lambda s: True),
        "elemdef.water": (0, 750, 40, "Water", "Defence against elementary damage", lambda s: True),
        "elemdef.ice": (0, 750, 40, "Ice", "Defence against elementary damage", lambda s: True),
        "elemdef.wind": (0, 750, 40, "Wind", "Defence against elementary damage", lambda s: True),
        "elemdef.earth": (0, 750, 40, "Earth", "Defence against elementary damage", lambda s: True),
        "spell.fire": (0, 750, None, "Fire", "A simple fire spell", lambda s: s["char.magic"] >= 2),
        "spell.water": (0, 750, None, "Water", "A basic fire spell", lambda s: s["char.magic"] >= 2),
        "spell.ice": (0, 750, None, "Ice", "A basic fire spell", lambda s: s["char.magic"] >= 2),
        "spell.wind": (0, 750, None, "Wind", "A basic fire spell", lambda s: s["char.magic"] >= 2),
        "spell.tornado": (0, 1250, None, "Tornado", "A basic fire spell", lambda s: s["char.magic"] >= 3),
        "spell.firestorm": (0, 1750, None, "Firestorm", "A basic fire spell", lambda s: s["char.magic"] >= 4),
        "spell.quake": (0, 1750, None, "Earthquake", "A basic fire spell", lambda s: s["char.magic"] >= 4),
        "spell.heal": (0, 250, None, "Heal", "A basic fire spell", lambda s: s["char.magic"] >= 1),
        "spell.invincibility": (0, 2250, None, "Invincibility", "A basic fire spell", lambda s: s["char.magic"] >= 5),
        "spell.haste": (0, 1250, None, "Haste", "A basic fire spell", lambda s: s["char.magic"] >= 3),
        "spell.slow": (0, 1250, None, "Slow", "A basic fire spell", lambda s: s["char.magic"] >= 3),
    }
